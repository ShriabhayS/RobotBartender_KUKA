...
//	private Gripper2FIOGroup gripperIO;
	...
	// NECESSARY FUNCTIONS FOR COMM.
    public int readRegister(int slaveId, int registerAddress) throws IOException {
...
//            writeRegister(65, 0, force);
            writeRegister(65, 1, position * 10);
...
//            writeRegister(65, 2, 1);
    ...
    public void setOffset(int offset) {
        try {
            writeRegister(65, 1031, offset*10); // Convert mm to cm for the register
            if (!offsetSet) {
...
//64 - Safety error
    ...
    public int[] initialise() {
        ...
        try {
        	...
        	logger.info("Current Width" + width);
        }
    ...
    public int readDepthRelative(){
        int depthRelative = -1;
        try {
            depthRelative = readRegister(65, 264);
	...
	public float readWidthOffset(){
        ...
        float widthActual = -1;
        try {
            widthActual = readRegister(65, 275);
